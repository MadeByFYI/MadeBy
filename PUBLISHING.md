...
2. **The Action is already pinned to `@v0.1.0`.** The quickstart references
   `MacDougherty/MadeBy/packages/action@v0.1.0` (not `@main`), so a maintainer's CI isn't tracking a
