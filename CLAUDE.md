...
The design is authoritative and lives in four root docs — consult them before implementing:

- `STRATEGY.md` — positioning (proof core, credit free tier), trust tiers, code-first/vibe-coding wedge, GTM, monetization
...
- `OPERATIONS.md` — provider stack, dashboards, cost governance, agentic ops
