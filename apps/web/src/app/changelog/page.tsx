// Public changelog (review 2026-06-29, Concern A): feedback visibly produces change — itself a
// trust-brand signal. Hand-curated for now; entries are added as user-facing changes ship.
