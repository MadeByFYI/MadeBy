// Coverage-led framing for the mirror result. We never lead with a confident "human" ratio —
// untrailered-AI recall is 0%. We lead with what we can PROVE and split the rest honestly:
