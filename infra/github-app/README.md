...
The MadeBy GitHub App does two jobs:
...
We only ever *read*, never execute or write, and we request
...
> You can create it under your personal account first and transfer
...
wire the OAuth callback once `apps/web` is deployed.
