...
const tools = [
    {
        ...
        description: "List all available legal representations that can be attached to content declarations. Returns STANDARD (good-faith assertion) and PERJURY (Gold Standard - under penalty of perjury with digital signature).",
        inputSchema: {
            type: "object",
            properties: {},
            required: [],
    ...
    },
    {
        ...
        description: "Create a new content declaration with a badge indicating whether content was made by humans (HUMAN), AI (AI), or with AI assistance (WITH_AI). Optionally attach a legal representation.",
        inputSchema: {
            type: "object",
            properties: {
                title: {
                ...
                contentType: {
                    ...
                    description: "Type of content: HUMAN (100% human-made), AI (AI-generated), WITH_AI (human-AI collaboration)",
                },
                description: {
                    type: "string",
                ...
                representationCode: {
                    ...
                    description: "Optional legal representation: STANDARD (good-faith) or PERJURY (Gold Standard with signature)",
                },
                signatureName: {
                    type: "string",
                    description: "Required for PERJURY representation: typed full legal name as digital signature",
                },
                contentHash: {
                    type: "string",
    ...
    },
    {
        ...
        description: "List the authenticated user's content declarations with pagination.",
        inputSchema: {
            type: "object",
            properties: {
                limit: {
    ...
    },
    {
        ...
        description: "Get a specific content declaration by ID, including its legal representation if attached.",
        inputSchema: {
            type: "object",
            properties: {
                id: {
    ...
    },
    {
        ...
        description: "Update an existing content declaration. Only the owner can update their declarations.",
        inputSchema: {
            type: "object",
            properties: {
                id: {
    ...
    },
    {
        ...
        description: "Delete a content declaration. Only the owner can delete their declarations.",
        inputSchema: {
            type: "object",
            properties: {
                id: {
...
async function handleToolCall(name, args) {
    switch (name) {
        ...
        case "list_declarations": {
            ...
            if (args.contentType)
                params.set("contentType", String(args.contentType));
