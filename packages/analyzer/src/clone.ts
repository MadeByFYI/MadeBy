...
// clone away — nearly stateless: shallow-clone, analyze, return; persist a claim only if claimed.
// This is the acquisition action — "see your breakdown" — and it needs no DB and no providers; it
// runs on localhost. Persistent/at-scale ingestion is #10.
//
