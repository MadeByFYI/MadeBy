...
// review. So today a perfectly-formed, signed declaration is *detected and pointed to* but
 ...
 */
export const MADEBY_ATTESTATION_V1_OPERATIVE = `[DRAFT — NOT FINAL LEGAL TEXT; PENDING COUNSEL REVIEW. This placeholder
...
export const DECLARATION_TEMPLATES: readonly DeclarationTemplate[] = [
  {
    ...
    operativeHash: "35c08ebf810cbc79994006037f1c2bf9adc4d5d74e91849836326e44f1f6f7fe",
  },
];
